...
const GRADING_CRITERIA = [
  ...
  {
    name: 'Nội dung', sub: 'Chất lượng & Chi tiết', key: 'content', maxScore: 4.0,
    levels: {
      'yếu': { score: '0.6-1.5', text: 'Sơ sài, chưa đạt mục tiêu.' },
      'tb': { score: '1.6-2.5', text: 'Đầy đủ nhưng chưa sâu.' },
      'khá': { score: '2.6-3.5', text: 'Tốt, giải quyết tốt mục tiêu.' },
      'giỏi': { score: '3.6-4.0', text: 'Xuất sắc, có tính mới.' }
    }
  },
  {
    name: 'Q&A', sub: 'Bản lĩnh & Kiến thức', key: 'qa', maxScore: 2.0,
    levels: {
      'yếu': { score: '0-0.8', text: 'Không trả lời được.' },
      'tb': { score: '0.9-1.2', text: 'Lúng túng, trả lời một phần.' },
      'khá': { score: '1.3-1.7', text: 'Rõ ràng, đúng trọng tâm.' },
      'giỏi': { score: '1.8-2.0', text: 'Xuất sắc, thuyết phục.' }
    }
  },
  {
...
function LecturerReviewerPage() {
  ...
  if (isLoading) return <Shell role="lecturer" user={user as any} breadcrumb={[]}><div className="h-64 flex items-center justify-center animate-pulse text-[#002068] font-black">CHARGING WORKSPACE...</div></Shell>

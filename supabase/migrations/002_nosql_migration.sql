...
-- Migrates from 14-table relational schema to 8-table document-based schema
-- Date: 2026-03-30

-- ============================================================================
-- PHASE 1: DROP EXISTING TABLES (cascade handles FK dependencies)
-- ============================================================================
...
-- Drop old indexes (will be recreated)
DROP INDEX IF EXISTS idx_profiles_email;
DROP INDEX IF EXISTS idx_profiles_role;
DROP INDEX IF EXISTS idx_profiles_student_code;
DROP INDEX IF EXISTS idx_semesters_is_current;
DROP INDEX IF EXISTS idx_semesters_is_active;
DROP INDEX IF EXISTS idx_proposals_supervisor;
DROP INDEX IF EXISTS idx_proposals_semester;
...
DROP INDEX IF EXISTS idx_registrations_proposal;
DROP INDEX IF EXISTS idx_registrations_status;
DROP INDEX IF EXISTS idx_submission_rounds_semester;
DROP INDEX IF EXISTS idx_submission_rounds_active;
DROP INDEX IF EXISTS idx_submissions_registration;
...
DROP INDEX IF EXISTS idx_grades_grader;
DROP INDEX IF EXISTS idx_grades_published;
DROP INDEX IF EXISTS idx_councils_semester;
DROP INDEX IF EXISTS idx_councils_status;
DROP INDEX IF EXISTS idx_council_members_council;
DROP INDEX IF EXISTS idx_council_members_member;
DROP INDEX IF EXISTS idx_defense_sessions_council;
DROP INDEX IF EXISTS idx_defense_sessions_registration;
DROP INDEX IF EXISTS idx_defense_sessions_status;
DROP INDEX IF EXISTS idx_defense_sessions_scheduled;
DROP INDEX IF EXISTS idx_feedback_registration;
DROP INDEX IF EXISTS idx_feedback_lecturer;
...
-- Drop old enums (no longer needed with text columns)
...
-- ============================================================================
-- PHASE 2: CREATE NEW NOSQL SCHEMA (8 tables, no FK constraints)
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- 2. semesters (academic periods with embedded rounds)
-- ----------------------------------------------------------------------------
...
CREATE INDEX idx_semesters_rounds ON semesters USING GIN (rounds);

-- ----------------------------------------------------------------------------
-- 3. proposals (thesis topics with embedded registration summaries)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 4. registrations (CORE - embeds submissions, grades, feedback, defense)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 5. councils (defense councils with embedded members and defenses)
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- PHASE 4: ROW LEVEL SECURITY (simplified for NoSQL)
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- profiles policies (simplified - no EXISTS subqueries)
-- ----------------------------------------------------------------------------
...
CREATE POLICY "everyone_view_profiles" ON profiles FOR SELECT
  USING (true); -- Allow viewing all profiles (needed for mentions/lookups)
...
-- ----------------------------------------------------------------------------
-- registrations policies (simplified - no joins)
-- ----------------------------------------------------------------------------
